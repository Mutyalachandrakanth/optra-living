...
const plans = [
  {
    ...
    tagline:
      "Full-service property management from listing to handover and beyond.",
    color: "#1a3c5e",
    lightColor: "#e8f0f8",
  ...
  },
  {
    ...
    tagline:
      "Tenant discovery, verification and handover — we find the right tenant fast.",
    color: "#2e7d52",
    lightColor: "#e8f5ee",
  ...
  return (
    <>
      ...
      >
        ...
        <Container maxWidth="xl" sx={{ position: "relative", zIndex: 1 }}>
          <Box sx={{ maxWidth: 640 }}>
            ...
            >
              Choose the plan that fits your property needs. All plans include a
              dedicated manager, verified tenants and full documentation.
            </Typography>
          </Box>
        </Container>
      </Box>
      ...
      <Box
        ...
        sx={{ backgroundColor: "#f8f9fb", py: { xs: 8, md: 10 } }}
      >
        <Container maxWidth="xl">
          ...
          <Box sx={{ mb: { xs: 6, md: 8 } }}>
            ...
            <Typography variant="body1" color="text.secondary" sx={{ mb: 5 }}>
              One-time or ongoing — structured to match how involved you want to
              be.
            </Typography>
                      ...
                      {plan.features.map((f) => (
                        <ListItem key={f} disablePadding sx={{ py: 0.5 }}>
                          <ListItemIcon sx={{ minWidth: 28 }}>
                            <CheckIcon
                              sx={{ fontSize: 15, color: plan.color }}
                            />
                          </ListItemIcon>
                          <ListItemText
                            primary={f}
            ...
            >
              <Box>
                ...
                <Typography
                  ...
                  sx={{ mt: 0.5 }}
                >
                  Applies to End-to-End Management plan — choose your billing
                  preference.
                </Typography>
              </Box>
              <Button
                        ...
                        <TableCell
                          ...
                          sx={{
                            ...
                            borderLeft: tier.highlight
                              ? "2px solid rgba(26,60,94,0.15)"
                              : "none",
                            borderRight: tier.highlight
                              ? "2px solid rgba(26,60,94,0.15)"
                              : "none",
                          }}
                        >
            ...
            >
              <Stack direction="row" gap={1} alignItems="flex-start">
                ...
                <Box>
                  ...
                  >
                    <strong>Placement fee</strong> applies when a new tenant is
                    placed. <strong>Tenant replacement fee</strong> is 1 month's
                    rent and applies if a tenant exits within the agreement term
                    and a new tenant is required.{" "}
                    <strong>Founding Charter</strong> is available to the first
                    50 landlords only and requires a 2-year commitment. All fees
                    are exclusive of GST where applicable. Management fees are
                    charged on rent collected.
                  </Typography>
                </Box>
              </Stack>
            </Box>
          ...
          >
            ...
            >
              Speak to our team — we&apos;ll recommend the right plan based on
